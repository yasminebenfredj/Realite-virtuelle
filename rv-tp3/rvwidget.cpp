...
void RVWidget::addObject(int type, QVector3D pos, QQuaternion orientation, QString name)
{
    ...
    case 0: // cube
        ...
        newObject->setFSFileName(":/shaders/FS_simple_texture.fsh");
    ...
    case 1: //dé
        ...
        break;
    case 2: //planet
        newObject = new RVPlanet(2.0);
        newObject->setTexture(":/textures/planet.jpg", true, true);
        dynamic_cast<RVPlanet*>(newObject)->setNightTexture(":/textures/planet2.jpg", true, true);
        break;
    case 3: //torus
