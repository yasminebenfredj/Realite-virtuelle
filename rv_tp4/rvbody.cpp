...
void RVBody::initializeVAO()
{
    ...
    program.setAttributeBuffer("rv_Position",
                               GL_FLOAT,
                               0,
                               3,
                               sizeof(RVVertex));
    ...
    program.setAttributeBuffer("rv_TexCoord",
                               GL_FLOAT,
                               sizeof(RVVertex::position),
                               2,
                               sizeof(RVVertex));
    program.enableAttributeArray("rv_TexCoord");

    program.setAttributeBuffer("rv_Normal",
                               GL_FLOAT,
                               sizeof(RVVertex::texCoord)+sizeof(RVVertex::position),
                               3,
                               sizeof(RVVertex));
...
RVLight *RVBody::getLight() const
{
    return light;
}

void RVBody::setLight(RVLight *newLight)
{
    light = newLight;
}

float RVBody::getSpecStrength() const
{
    return specStrength;
}

void RVBody::setSpecStrength(float newSpecStrength)
{
